...
st.write("Enter the text to convert to speech using the pt-BR-AntonioNeural voice. The audio will play automatically.")
...
if user_text.strip():
    ...
    st.info("Please enter text to generate audio.")